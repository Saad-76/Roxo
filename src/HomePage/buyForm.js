...
const BuyForm=()=>{
    ...
    return(
        <>
        <div className="buy-form-background">
        <Header/>
    <div className="col-md-12 sell-main-heading">
<h3>BUY <span className="color-sell"> TOKENS  </span></h3>
...
<div className="col-md-12 sell-button-main">
    <div className="col-md-6">
        <button className="sell-button-inner">Buy</button>
    </div>
...
<label>From</label>
<input className="input-field-sellfrom-inner" type="number"    min="0" max="10000000"/>
</div>
<div className="col-md-12 input-display-sellform ">
<label>To</label>
<input  className="input-field-sellfrom-inner" type="number" min="0" max="10000000" />
...
<div className="col-md-12 text-sell-form">
    <p>The displaying number is the simulated result<br/>
    and can be different from the actual swap rate.<br/>
