...
const GamingNft = () => {
  ...
  return (
    <>
    <div className="gaming-nft-outer">
          ...
          <div className="col-md-12 gaming-nft-inner-flex">
            ...
            <div className="col-md-8">
              ...
              <div className="gaming-nft-link-buttons">
                <button className="gaming-nft-link-button-inner">Link1</button>
                <button className="gaming-nft-link-button-inner">Link2</button>
                <button className="gaming-nft-link-button-inner">Link3</button>
              </div>
              {/* </div> */}
            </div>
          </div>
