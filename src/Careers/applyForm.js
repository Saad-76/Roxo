  ...
  return (
    <>
      ...
      <div className="col-md-12 d-flex">
        <div className="col-md-6 icons-back-style-one">
          <Link to="/apply">
            <BiArrowBack size={50} />{" "}
          </Link>
        </div>
        <div className="col-md-6 icons-backstyle-two">
          <Link to="/apply icons-back-style-two">
            <MdOutlineCancelPresentation size={50} />
          </Link>
        </div>
      </div>
    <div className="container-applyForm">
        ...
        <h5 className="submit-application-heading">Submit Your Application</h5>
          ...
          <div className="input-fieds-outer col-md-12">
            <label className="col-md-6 career-form-label">Highest Education*</label>
            <div className="col-md-6  input-field-style">
          ...
          <div className="input-fieds-outer col-md-12">
            <label className="col-md-6 career-form-label">Expected Work Place*</label>
            <div className="col-md-6  input-field-style">
          ...
          <div className="input-fieds-outer col-md-12">
            ...
            <input className=" input-field-inner"  type="file" id="test" name="test" accept=".pdf,.doc" />
            </div>
          ...
          <div className="input-fieds-outer col-md-12">
            ...
            <textarea className=" input-field-inner"  placeholder="Type message here..." />
            </div>

          </div>

          <button className="submit-application-button" onClick={Alert}> Submit Application</button>
        </div>
        </div>
        </div>
    </>
